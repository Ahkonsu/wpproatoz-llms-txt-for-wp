...
Overview
The LLMs.txt for WP plugin makes your WordPress site ready for Large Language Models (LLMs) like ChatGPT, Gemini, and Claude. Forked from the original llms-txt-for-wp by Balázs Piller, this updated version adds robust security, performance enhancements, and modern WordPress compatibility. It generates an llms.txt file with structured, machine-readable content and supports Markdown versions of posts/pages via .md URLs.
...
Open Source: Licensed under GPLv2, with contributions welcome on GitHub.
...
Install Dependencies:cd /path/to/plugin/wpproatoz-llms-txt-for-wp
composer install
